...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/03/11 18:52:32 by msrun             #+#    #+#             */
/*   Updated: 2017/03/13 17:21:59 by bandre           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#ifndef COREWAR_MSRUN_H
# define COREWAR_MSRUN_H
...
void			ft_and_fill_reg(unsigned char *tab1,
		unsigned char *tab2, unsigned char *tab3);
void			ft_or_fill_reg(unsigned char *tab1,
		unsigned char *tab2, unsigned char *tab3);
void			ft_xor_fill_reg(unsigned char *tab1,
		unsigned char *tab2, unsigned char *tab3);
